...
CHROMA_DIR = os.getenv("CHROMA_DIR", r"../chroma_db_openai_large_kw")  # 예: C:\...\embedding\chroma_db
COLLECTION_NAME = os.getenv("CHROMA_COLLECTION", "hscode_collection")

# 인덱싱 때 썼던 임베딩 모델과 반드시 동일하게!
EMBED_MODEL = os.getenv("EMBED_MODEL", "text-embedding-3-large") # 모델 변경!
