...
# =========================
try:
    from RAG_openai_large_kw import classify_hs_code_rag  # 사용자 환경 우선 (RAG_e5_large_kw로 단일화)
except ImportError:
    # 대체 경로를 찾을 수 없으므로, RAG_e5_large_kw 파일의 경로를 확인하도록 안내
    print("❌ classify_hs_code_rag 임포트 실패. RAG_e5_large_kw.py 파일이 없거나 경로가 잘못되었습니다.")
    sys.exit(1)
